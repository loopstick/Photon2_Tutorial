...
- What does the blinking light mean?
  ...
  [Particle Status LED and Device Modes](https://docs.particle.io/troubleshooting/led/photon/)
...
Try this... find example code here -> [P2T_LED_LDR_V2](https://go.particle.io/shared_apps/650bb25423d6c200156a19d5)  (right-click: Open Link in New Tab)
